...
The real ETC logo is a square navy rectangle (`#00216C`) with three white letterforms (E, T, C). Use the full SVG below wherever a logo is needed. For the nav logo mark (small 28×28px badge), use the abbreviated version.
...
### Nav Logo Mark (28×28px badge)

```html
<a href="#" class="logo">
  <span class="logo-mark">
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
      <path d="M2.5 12.5L7.5 2.5L12.5 12.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M4.5 9L10.5 9" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
    </svg>
  </span>
  ETC Solutions
</a>
...
- On dark backgrounds, the logo mark uses `--orange-500` as background instead
- Never stretch, recolor, or add effects to the full logo SVG
...
.logo { font-family: var(--font-ui); font-size: 15px; font-weight: 600; color: var(--text); text-decoration: none; letter-spacing: -0.02em; display: flex; align-items: center; gap: 9px; }
.nav-links { display: flex; align-items: center; gap: 28px; list-style: none; }
.nav-links a { font-family: var(--font-ui); font-size: 14px; font-weight: 400; color: var(--text-mid); text-decoration: none; transition: color 0.15s; }
...
```css
.btn { font-family: var(--font-ui); font-size: 14px; font-weight: 500; padding: 10px 20px; border-radius: var(--r-btn); cursor: pointer; text-decoration: none; transition: all 0.18s ease; display: inline-flex; align-items: center; gap: 6px; border: none; letter-spacing: -0.01em; white-space: nowrap; }
.btn.lg { font-size: 15px; padding: 13px 26px; border-radius: 12px; }
.btn-primary { background: var(--blue); color: white; }
.btn-primary:hover { background: var(--blue-hover); transform: translateY(-1px); box-shadow: 0 6px 20px rgba(31,63,216,0.22); }
...
**All links: weight 400, color `--blue-500`, no underline.**

```css
.feature-link { font-family: var(--font-ui); font-size: 13px; font-weight: 400; color: var(--blue); text-decoration: none; display: inline-flex; align-items: center; gap: 4px; transition: gap 0.15s; }
.feature-link:hover { gap: 7px; }

.link-arrow { font-family: var(--font-ui); font-size: 14px; font-weight: 400; color: var(--text-mid); text-decoration: none; display: inline-flex; align-items: center; gap: 5px; transition: color 0.15s; }
.link-arrow:hover { color: var(--text); }

.blog-link { font-family: var(--font-ui); font-size: 12px; font-weight: 400; color: var(--text-mid); text-decoration: none; display: inline-flex; align-items: center; gap: 4px; transition: color 0.15s; }
...
```css
.overline { font-family: var(--font-ui); font-size: 12px; font-weight: 500; color: var(--orange); margin-bottom: 12px; display: block; }
```
...
.feature-cell { background: var(--bg-card); padding: 36px 30px 32px; display: flex; flex-direction: column; transition: background 0.15s; }
.feature-cell:hover { background: var(--neutral-50); }
...
.feature-body { font-family: var(--font-ui); font-size: 14px; line-height: 1.65; color: var(--text-mid); flex: 1; margin-bottom: 14px; }
...
.why-left p { font-family: var(--font-ui); font-size: 15px; color: var(--text-mid); line-height: 1.75; }
...
.why-item-title { font-family: var(--font-editorial); font-size: 17px; font-weight: 500; color: var(--text); margin-bottom: 4px; letter-spacing: -0.01em; }
.why-item-body { font-family: var(--font-ui); font-size: 14px; color: var(--text-mid); line-height: 1.65; }
```
...
.blog-meta { font-family: var(--font-ui); font-size: 11px; color: var(--text-mid); margin-bottom: 8px; }
.blog-title { font-family: var(--font-editorial); font-size: 17px; font-weight: 400; line-height: 1.4; color: var(--text); letter-spacing: -0.01em; flex: 1; margin-bottom: 18px; }
...
.quote-text { font-family: var(--font-editorial); font-size: clamp(19px, 2.5vw, 27px); font-weight: 400; font-style: italic; line-height: 1.55; color: var(--text); max-width: 680px; margin: 0 auto 32px; letter-spacing: -0.01em; }
.author-avatar { width: 38px; height: 38px; border-radius: 50%; background: var(--slate-100); border: 1px solid var(--border); display: flex; align-items: center; justify-content: center; font-family: var(--font-ui); font-size: 11px; font-weight: 600; color: var(--blue); margin: 0 auto 8px; }
.author-name { font-family: var(--font-ui); font-size: 13px; font-weight: 600; color: var(--text); display: block; }
.author-role { font-family: var(--font-ui); font-size: 12px; color: var(--text-light); display: block; margin-top: 2px; }
```
...
.hero-stat-number { font-family: var(--font-ui); font-size: 28px; font-weight: 400; color: var(--text); letter-spacing: -0.03em; line-height: 1; }
.hero-stat-number .suffix { color: var(--orange); }
.hero-stat-label { font-family: var(--font-ui); font-size: 13px; color: var(--text-light); }
...
| Element | Animation |
|---------|-----------|
| Feature + blog cards | `transform: translateY(-3px)` on hover |
| Buttons | `transform: translateY(-1px)` + box-shadow on hover |
| Feature link arrow | gap `4px` → `7px` on hover, `transition: gap 0.15s` |
| Colors / borders | `transition: color 0.15s` or `transition: background 0.15s` |
| Buttons (all) | `transition: all 0.18s ease` |

No scroll animations, entrance animations, count-up numbers, or parallax.
...
| Count-up number animations | Static numbers, inline in hero |
